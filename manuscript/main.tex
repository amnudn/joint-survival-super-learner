...
\begin{algorithm}[H]
  ...
  \For{$k = 1, \dots, K$}{
    ...
    \For{$(a_1, a_2, b) \in
      ...
      \), \( a_2(\data_n^{-k}) \in \hat{\mathcal{A}}_2^{-k} \),
      and \( b(\data_n^{-k}) \in \hat{\mathcal{B}}^{-k} \) to
      obtain the fitted \( F \)-learner,
      \( \phi_{a_1, a_2, b}(\data_n^{-k}) \).
    ...
    \For{$(a_1, a_2, b) \in \mathcal{A}_1 \times \mathcal{A}_2 \times
      \mathcal{B} $}{ Calculate the cross-validated risk:
