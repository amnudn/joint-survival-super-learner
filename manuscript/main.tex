...
constant hazard functions. This is an interesting idea which we
...
whereas {\sl survSL} combines the learners. We conjecture that a
...
library of learners and hence this could be an explanation of why the discrete joint survival super learner outperforms {\it survSL} in this scenario.
...
These results illustrate that the proposed joint survival super
...
In summary, the findings from our simulation study and the analysis of
the prostate cancer data confirm the practical feasibility and
interpretability of the approach, and highlight how the joint super
learner framework can support model selection and validation in
complex event-history prediction problems.
