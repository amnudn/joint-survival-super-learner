...
see that the discrete joint survival super learner is competitive for
...
regression model, the Brier score is lower for the discrete joint
survival super learner), and much better at predicting the 3-year
probabilities.
