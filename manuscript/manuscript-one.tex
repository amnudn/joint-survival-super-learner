...
inequality below (Proposition~\ref{sec:finite-sample-oracle}), this
...
finite-sample oracle inequality is that, informally, JSSL converges at
(nearly) the optimal rate achievable within the library. This
statement is made precise in Corollary~\ref{sec:finite-sample-oracle}
...
\begin{corollary}
  ...
  such that
  \( \frac{1}{K}\sum_{k=1}^{K} \E_{P}{\left[  \Vert \phi_n(\data_n^{-k}) - F_P \Vert_{P}^2 \right]} =
