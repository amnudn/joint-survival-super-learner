...
The use of cross-validation underlying the joint survival super learner is an intuitively
...
implies that the joint survival super learner is consistent when it is based on a library that
includes a consistent learner. Another consequence of our
finite-sample oracle inequality is that the joint survival super learner converges at (nearly) the
...
To evaluate the performance of the joint survival super learner we might benchmark it against the
